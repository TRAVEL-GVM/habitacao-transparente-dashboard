...
def show_satisfaction_levels_tab(df):
    ...
    with col2:
        ...
        housing_type_satisfaction = (
            filtered_df.groupby(["house_type", "bedroom_count"])
            .size()
    ...
    district_satisfaction_dict = district_satisfaction.set_index("distrito_geojson")[
        "satisfaction_score"
    ].to_dict()
    ...
    def highlight_function(feature):
        return {"weight": 3, "color": "#666", "dashArray": "", "fillOpacity": 0.7}
