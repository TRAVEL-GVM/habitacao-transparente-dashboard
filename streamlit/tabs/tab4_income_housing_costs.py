...
def show_income_housing_costs_tab(df):
    ...
    with col2:
        ...
        if not rent_data.empty:
            ...
            rent_data.loc[:, 'percentagem-renda-paga'] = pd.to_numeric(rent_data['percentagem-renda-paga'], errors='coerce')
    ...
    with col2:
        ...
        # Calculate housing cost to income ratio
        housing_cost_data['monthly_income'] = housing_cost_data['rendimento_numerical'] / 12
        housing_cost_data['housing_cost_ratio'] = \
            housing_cost_data['monthly_housing_cost'] / housing_cost_data['monthly_income'] * 100
    ...
    with col1:
        ...
        rent_time_data['rental_year'] = rent_time_data['ano-inicio-arrendamento'].astype(float).astype('Int64')
        
        # Group by year and calculate average rent
        yearly_rent = rent_time_data.groupby('rental_year')['valor-mensal-renda'].mean().reset_index()
    ...
    with col2:
        ...
        rent_time_data['rent_income_ratio'] = \
            (rent_time_data['valor-mensal-renda'] * 12 / rent_time_data['rendimento_numerical']) * 100
        
        yearly_ratio = rent_time_data.groupby('rental_year')['rent_income_ratio'].mean().reset_index()
    ...
    with col1:
        ...
        district_rent = df[df['housing_situation'] == 'Renting'].groupby('distrito')['valor-mensal-renda'].mean().reset_index()
    ...
    with col2:
        ...
        district_affordability['Affordability Index'] = affordable_housing / district_affordability['Average Rent']
        district_affordability['Affordable'] = district_affordability['Affordability Index'] >= 1
        district_affordability = district_affordability.sort_values('Affordability Index', ascending=False)
